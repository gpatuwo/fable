...
ActiveRecord::Schema.define(version: 20160907003522) do
  ...
  add_index "taggings", ["tag_name"], name: "index_taggings_on_tag_name", using: :btree
  add_index "taggings", ["veg_id"], name: "index_taggings_on_veg_id", using: :btree
